...
do
./test/func_test_RK/generate_func_test_RK_$type.o S 1420 1420 U
./test/func_test_RK/func_test_RK_$type.o S 1420 1420 U
done
...
for type in {'SINGLE','DOUBLE','COMPLEX','COMPLEX16'}
    do
    ./test/func_test_ROOK/generate_func_test_ROOK_$type.o S 186 121 L
    ./test/func_test_ROOK/func_test_ROOK_$type.o S 186 121 L
    done
