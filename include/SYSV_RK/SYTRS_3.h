...
/**
 * ////////////////////////////////SYTRS_3///////////////////////////////////////
 * @Brief SSYTRS_3 solves a system of linear equations A * X = B with a
 symmetric matrix A using the factorization computed by SYTRF_RK or _SYTRF_BK:
    RESID = norm(B - A*X) / ( norm(A) * norm(X) * EPS ), where EPS is the
 machine epsilon.
